...
exports.length = exports.evaluate = exports.join = exports.init = exports.last = exports.tail = exports.head = exports.list = exports.reduce = exports.foreach = exports.map = undefined;
...
var reduce = exports.reduce = function reduce() {
  var _processList5 = (0, _util.processList)([].concat(Array.prototype.slice.call(arguments))),
      _processList6 = _slicedToArray(_processList5, 3),
      func = _processList6[0],
      list = _processList6[1],
      init = _processList6[2];
