...
var list = parsec.lazy(function () {
  ...
  return (_builtins$or$trim$man = builtins.or(grammar.types.boolean, grammar.types.symbol, grammar.types.string, parsec.int, unevaluatedStatment, evaluatedStatment).trim().many()).between.apply(_builtins$or$trim$man, _toConsumableArray(grammar.chars.parenthesis));
});
